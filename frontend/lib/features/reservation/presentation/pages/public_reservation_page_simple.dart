...
/// Page de réservation publique simplifiée
/// Copie le formulaire admin mais adapté pour les clients
class PublicReservationPageSimple extends ConsumerStatefulWidget {
  const PublicReservationPageSimple({super.key});

  @override
  ConsumerState<PublicReservationPageSimple> createState() => _PublicReservationPageSimpleState();
}

class _PublicReservationPageSimpleState extends ConsumerState<PublicReservationPageSimple> {
